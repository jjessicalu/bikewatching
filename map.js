...
mapboxgl.accessToken = 'pk.eyJ1IjoiamVsMTgxIiwiYSI6ImNtcDZnYW5qczBuOGcycHEyZGI2ZzZiaXcifQ.FuuCiIXN29qflkBav66rFA';
...
map.on('load', async () => {
  ...
  console.log('Stations Traffic Data:', stations);
